...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("Module"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_Module(void) {
...
function_impl_code functable_Module[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_Module;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_Module) || offset < 0) {
...
PyObject *modulecode_Module(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("Module: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("Module: Calling createModuleCodeObjects().\n");
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_Module);
...
// Mark the execution in the "__spec__" value.
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT1(moduledict_Module, (Nuitka_StringObject *)mod_consts[8], tmp_assign_source_1);
    }
